...
def dashboard(request):
    ...
    return render(request, "dashboard/dashboard.html", {"section": "profile", "orders": orders})
...
def edit_details(request):
    ...
    return render(request, "dashboard/edit_details.html", {"user_form": user_form})
...
def account_register(request):
    ...
    if request.method == "POST":
        ...
        if registerForm.is_valid():
            ...
            return render(request, "register_email_confirm.html", {"form": registerForm})
    else:
...
def add_address(request):
    ...
    return render(request, "dashboard/edit_addresses.html", {"form": address_form})
